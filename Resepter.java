...
public class Resepter {
    ...
    public Resepter(Legemiddler legemiddel, Leger lege, Personer pasient, int pris, int reit){
...
class BlaaResept extends Resepter{
        private int pris;
    public BlaaResept(Legemiddler legemiddel, Leger lege, Personer pasient, int pris, int reit){
        super(legemiddel,lege,pasient,pris,reit);
        this.pris=pris;
        this.pris=0;
    }
    public int getPris(){return pris;}
